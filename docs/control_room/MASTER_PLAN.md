...
| 3 Cues and moderation | T0 synthetic communication-engine slice merged; T1 readiness scaffold in progress; gate not passed | G2 plus output policy | Bounded cues, safe renderer, moderator cases, human decisions and appeal | Synthetic fixture and synthetic protocol tests only; no raw logs or autonomous sanctions | Motive inference, raw-content leakage, or absent appeal | Safety owner | G3 not passed |
...
The governed-foundation implementation completed after Backlog Issue 13. The merged Berlin communication-engine milestone adds a disabled-by-default, loopback, fictional-fixture review slice under D004/D018/D019. D020 permits a separately disabled T1 protocol-readiness scaffold using fictional tests only. Neither milestone satisfies participant/research/beta Gates G2–G9 or SG1–SG6; Issues 14–25 require separate owner-approved goals.
